      ...
      with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while cap.isOpened():
            ...
            try:
                ...
                # Calculate angle
                lkangle = int(calculate_angle(lhip, lknee, lankle))
                rkangle = int(calculate_angle(rhip, rknee, rankle))
                ...
                # lunge counter logic
                if (lkangle > 110 and rkangle > 110):
                    stage = "down"
                if (lkangle > 140 and rkangle > 140 and stage == 'down'):
                    stage = "up"
                    counter +=1
                    print(counter)
